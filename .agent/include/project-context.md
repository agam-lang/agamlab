...
- Repository: `agam-lang/agamlab`
- Purpose: Provide a MATLAB-class interactive scientific computing environment built natively on top of the Agam language and toolchain.
- Technology: Rust workspace with Agam-native numerical libraries
